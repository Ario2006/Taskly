...
import { Linkedin, Twitter, Facebook, Instagram, Youtube, CheckSquare } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <span>Taskly</span>
              ...
              <div className="mt-3">
                ...
                <Link href="/support" legacyBehavior>
                    <a className="cursor-none hover:text-blue-400 transition-colors text-sm">
                        Visit Help & Support
                    </a>
                </Link>
              </div>
            ...
            <div className="md:col-span-2 lg:col-span-2">
              ...
              <ul className="space-y-3">
                <li><Link href="/pricing" legacyBehavior><a className="hover:text-yellow-400 transition-colors">Pricing</a></Link></li>
                <li><Link href="/features" legacyBehavior><a className="hover:text-yellow-400 transition-colors">Features</a></Link></li>
                <li><Link href="/integrations" legacyBehavior><a className="hover:text-yellow-400 transition-colors">Integrations</a></Link></li>
                <li><Link href="/about" legacyBehavior><a className="hover:text-yellow-400 transition-colors">About us</a></Link></li>
                <li><Link href="/contact" legacyBehavior><a className="hover:text-yellow-400 transition-colors">Contact us</a></Link></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-3">
                <li><Link href="/terms-of-service" legacyBehavior><a className="hover:text-pink-400 transition-colors">Terms of service</a></Link></li>
                <li><Link href="/privacy-policy" legacyBehavior><a className="hover:text-pink-400 transition-colors">Privacy policy</a></Link></li>
                <li><Link href="/cookie-policy" legacyBehavior><a className="hover:text-pink-400 transition-colors">Cookie policy</a></Link></li>
                <li><Link href="/security" legacyBehavior><a className="hover:text-pink-400 transition-colors">Security</a></Link></li>
              </ul>
            </div>
          </div>
